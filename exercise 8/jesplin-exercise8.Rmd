...
ggplot(data = data, aes(x = x, y = y)) +
  geom_point() +
  geom_smooth(methods = "lm") + # it should be method, not methods...
...
ggplot(data = data, aes(x = Assault, y = Murder)) +
  geom_point() +
...
## ms: you can label it by doing this:
...
## ms: you can format the graph like this--specifically, using las (to make the x-axis ticks vertical, and cex-names to make the text smaller)

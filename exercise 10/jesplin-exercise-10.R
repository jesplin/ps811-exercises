## followed code instructions as closely as I could
## then extended dataset to Sotomayor 
...
bork <- read_dta(here("exercise 10/Bork.dta")) # download from https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/W5CV8E&version=1.0
...
poole <- read_dta(here("exercise 10/Weekly_DW-NOMINATE_31.DTA")) # download from https://legacy.voteview.com/Weekly_Constant_Space_DW-NOMINATE_Scores.htm
...
congress109 <- read_dta(here("exercise 10/sen109kh.dta")) 
...
congress111 <- read_dta(here("exercise 10/sen111kh.dta")) 
